<x-dashboard-layout title="Verify Password Change">
    <x-slot name="header">Verify Password Change</x-slot>
    ...
    <div class="max-w-lg mx-auto">
        <div class="bg-white border border-gray-200 p-6 text-center">
            ...
            <p class="text-sm text-gray-500 mb-6">A 6-digit code has been sent to your phone (<strong>{{ auth()->user()->phone }}</strong>). Enter it to confirm the password change.</p>
            ...
            <form action="{{ route('profile.verify-password-otp.post') }}" method="POST">
                @csrf
